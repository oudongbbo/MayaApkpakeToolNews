...
.method constructor <init>(Lcom/maya/open/http/okio/ByteString;Lcom/maya/open/http/okhttp3/MediaType;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/maya/open/http/okhttp3/MultipartBody;->contentType:Lcom/maya/open/http/okhttp3/MediaType;
    ...
    iput-object p1, p0, Lcom/maya/open/http/okhttp3/MultipartBody;->parts:Ljava/util/List;
...
.method private writeOrCountBytes(Lcom/maya/open/http/okio/BufferedSink;Z)J
    ...
    .line 131
    :goto_0
    iget-object v1, p0, Lcom/maya/open/http/okhttp3/MultipartBody;->parts:Ljava/util/List;
    ...
    .line 132
    iget-object v6, p0, Lcom/maya/open/http/okhttp3/MultipartBody;->parts:Ljava/util/List;

    invoke-interface {v6, v3}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lcom/maya/open/http/okhttp3/MultipartBody$Part;

    .line 133
    iget-object v7, v6, Lcom/maya/open/http/okhttp3/MultipartBody$Part;->headers:Lcom/maya/open/http/okhttp3/Headers;

    .line 134
    iget-object v6, v6, Lcom/maya/open/http/okhttp3/MultipartBody$Part;->body:Lcom/maya/open/http/okhttp3/RequestBody;

    .line 136
    sget-object v8, Lcom/maya/open/http/okhttp3/MultipartBody;->DASHDASH:[B

    invoke-interface {p1, v8}, Lcom/maya/open/http/okio/BufferedSink;->write([B)Lcom/maya/open/http/okio/BufferedSink;

    .line 137
    iget-object v8, p0, Lcom/maya/open/http/okhttp3/MultipartBody;->boundary:Lcom/maya/open/http/okio/ByteString;

    invoke-interface {p1, v8}, Lcom/maya/open/http/okio/BufferedSink;->write(Lcom/maya/open/http/okio/ByteString;)Lcom/maya/open/http/okio/BufferedSink;

    .line 138
    sget-object v8, Lcom/maya/open/http/okhttp3/MultipartBody;->CRLF:[B
    ...
    .line 141
    invoke-virtual {v7}, Lcom/maya/open/http/okhttp3/Headers;->size()I
    ...
    .line 142
    invoke-virtual {v7, v9}, Lcom/maya/open/http/okhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v10

    invoke-interface {p1, v10}, Lcom/maya/open/http/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/maya/open/http/okio/BufferedSink;

    move-result-object v10

    sget-object v11, Lcom/maya/open/http/okhttp3/MultipartBody;->COLONSPACE:[B

    .line 143
    invoke-interface {v10, v11}, Lcom/maya/open/http/okio/BufferedSink;->write([B)Lcom/maya/open/http/okio/BufferedSink;

    move-result-object v10

    .line 144
    invoke-virtual {v7, v9}, Lcom/maya/open/http/okhttp3/Headers;->value(I)Ljava/lang/String;

    move-result-object v11

    invoke-interface {v10, v11}, Lcom/maya/open/http/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/maya/open/http/okio/BufferedSink;

    move-result-object v10

    sget-object v11, Lcom/maya/open/http/okhttp3/MultipartBody;->CRLF:[B
    ...
    .line 149
    :cond_1
    invoke-virtual {v6}, Lcom/maya/open/http/okhttp3/RequestBody;->contentType()Lcom/maya/open/http/okhttp3/MediaType;
    ...
    .line 151
    invoke-interface {p1, v8}, Lcom/maya/open/http/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/maya/open/http/okio/BufferedSink;

    move-result-object v8

    .line 152
    invoke-virtual {v7}, Lcom/maya/open/http/okhttp3/MediaType;->toString()Ljava/lang/String;

    move-result-object v7

    invoke-interface {v8, v7}, Lcom/maya/open/http/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/maya/open/http/okio/BufferedSink;
    ...
    .line 153
    invoke-interface {v7, v8}, Lcom/maya/open/http/okio/BufferedSink;->write([B)Lcom/maya/open/http/okio/BufferedSink;
    ...
    .line 158
    invoke-interface {p1, v9}, Lcom/maya/open/http/okio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lcom/maya/open/http/okio/BufferedSink;

    move-result-object v9

    .line 159
    invoke-interface {v9, v7, v8}, Lcom/maya/open/http/okio/BufferedSink;->writeDecimalLong(J)Lcom/maya/open/http/okio/BufferedSink;
    ...
    .line 160
    invoke-interface {v9, v10}, Lcom/maya/open/http/okio/BufferedSink;->write([B)Lcom/maya/open/http/okio/BufferedSink;
    ...
    :cond_4
    :goto_3
    sget-object v9, Lcom/maya/open/http/okhttp3/MultipartBody;->CRLF:[B

    invoke-interface {p1, v9}, Lcom/maya/open/http/okio/BufferedSink;->write([B)Lcom/maya/open/http/okio/BufferedSink;
    ...
    .line 172
    :cond_5
    invoke-virtual {v6, p1}, Lcom/maya/open/http/okhttp3/RequestBody;->writeTo(Lcom/maya/open/http/okio/BufferedSink;)V

    .line 175
    :goto_4
    sget-object v6, Lcom/maya/open/http/okhttp3/MultipartBody;->CRLF:[B

    invoke-interface {p1, v6}, Lcom/maya/open/http/okio/BufferedSink;->write([B)Lcom/maya/open/http/okio/BufferedSink;
    ...
    .line 178
    :cond_6
    sget-object v1, Lcom/maya/open/http/okhttp3/MultipartBody;->DASHDASH:[B

    invoke-interface {p1, v1}, Lcom/maya/open/http/okio/BufferedSink;->write([B)Lcom/maya/open/http/okio/BufferedSink;

    .line 179
    iget-object v1, p0, Lcom/maya/open/http/okhttp3/MultipartBody;->boundary:Lcom/maya/open/http/okio/ByteString;

    invoke-interface {p1, v1}, Lcom/maya/open/http/okio/BufferedSink;->write(Lcom/maya/open/http/okio/ByteString;)Lcom/maya/open/http/okio/BufferedSink;
    ...
    .line 181
    sget-object v1, Lcom/maya/open/http/okhttp3/MultipartBody;->CRLF:[B
...
.method public contentLength()J
    ...
    .line 110
    invoke-direct {p0, v0, v1}, Lcom/maya/open/http/okhttp3/MultipartBody;->writeOrCountBytes(Lcom/maya/open/http/okio/BufferedSink;Z)J
...
.method public part(I)Lcom/maya/open/http/okhttp3/MultipartBody$Part;
    ...
    check-cast p1, Lcom/maya/open/http/okhttp3/MultipartBody$Part;
