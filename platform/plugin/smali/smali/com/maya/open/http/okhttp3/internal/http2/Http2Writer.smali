...
.method public constructor <init>(Lcom/maya/open/http/okio/BufferedSink;Z)V
    ...
    iput-object p1, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->hpackBuffer:Lcom/maya/open/http/okio/Buffer;

    .line 62
    new-instance p1, Lcom/maya/open/http/okhttp3/internal/http2/Hpack$Writer;

    iget-object p2, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->hpackBuffer:Lcom/maya/open/http/okio/Buffer;

    invoke-direct {p1, p2}, Lcom/maya/open/http/okhttp3/internal/http2/Hpack$Writer;-><init>(Lcom/maya/open/http/okio/Buffer;)V

    iput-object p1, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->hpackWriter:Lcom/maya/open/http/okhttp3/internal/http2/Hpack$Writer;

    const/16 p1, 0x4000

    .line 63
    iput p1, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->maxFrameSize:I
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 293
    :goto_1
    invoke-virtual {p0, p1, v2, v5, v0}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
...
.method private static writeMedium(Lcom/maya/open/http/okio/BufferedSink;I)V
    ...
    .line 286
    invoke-interface {p0, p1}, Lcom/maya/open/http/okio/BufferedSink;->writeByte(I)Lcom/maya/open/http/okio/BufferedSink;
...
.method public declared-synchronized applyAndAckSettings(Lcom/maya/open/http/okhttp3/internal/http2/Settings;)V
    ...
    invoke-virtual {v0, p1}, Lcom/maya/open/http/okhttp3/internal/http2/Hpack$Writer;->setHeaderTableSizeSetting(I)V
    ...
    .line 87
    invoke-virtual {p0, v1, v1, p1, v0}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V

    .line 88
    iget-object p1, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->sink:Lcom/maya/open/http/okio/BufferedSink;
...
.method dataFrame(IBLcom/maya/open/http/okio/Buffer;I)V
    ...
    invoke-interface {p1, p3, v0, v1}, Lcom/maya/open/http/okio/BufferedSink;->write(Lcom/maya/open/http/okio/Buffer;J)V
...
.method public frameHeader(IIBB)V
    ...
    .line 273
    iget-object p2, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->sink:Lcom/maya/open/http/okio/BufferedSink;
    ...
    invoke-interface {p2, p1}, Lcom/maya/open/http/okio/BufferedSink;->writeInt(I)Lcom/maya/open/http/okio/BufferedSink;
    ...
    invoke-static {p1, p2}, Lcom/maya/open/http/okhttp3/internal/http2/Http2;->illegalArgument(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/IllegalArgumentException;
    ...
    iget p3, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->maxFrameSize:I
    ...
    invoke-static {p2, p1}, Lcom/maya/open/http/okhttp3/internal/http2/Http2;->illegalArgument(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/IllegalArgumentException;
...
.method public declared-synchronized goAway(ILcom/maya/open/http/okhttp3/internal/http2/ErrorCode;[B)V
    ...
    .line 239
    invoke-virtual {p0, v2, v0, v1, v2}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V

    .line 240
    iget-object v0, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->sink:Lcom/maya/open/http/okio/BufferedSink;

    invoke-interface {v0, p1}, Lcom/maya/open/http/okio/BufferedSink;->writeInt(I)Lcom/maya/open/http/okio/BufferedSink;

    .line 241
    iget-object p1, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->sink:Lcom/maya/open/http/okio/BufferedSink;

    iget p2, p2, Lcom/maya/open/http/okhttp3/internal/http2/ErrorCode;->httpCode:I

    invoke-interface {p1, p2}, Lcom/maya/open/http/okio/BufferedSink;->writeInt(I)Lcom/maya/open/http/okio/BufferedSink;
    ...
    invoke-interface {p1, p3}, Lcom/maya/open/http/okio/BufferedSink;->write([B)Lcom/maya/open/http/okio/BufferedSink;
...
.method headers(ZILjava/util/List;)V
    ...
    .line 302
    iget-object p3, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->hpackBuffer:Lcom/maya/open/http/okio/Buffer;
    ...
    .line 307
    invoke-virtual {p0, p2, p3, p1, v4}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
    ...
    invoke-interface {p1, p3, v2, v3}, Lcom/maya/open/http/okio/BufferedSink;->write(Lcom/maya/open/http/okio/Buffer;J)V
    ...
    .line 310
    invoke-direct {p0, p2, v0, v1}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->writeContinuationFrames(IJ)V
...
.method public declared-synchronized ping(ZII)V
    ...
    .line 217
    invoke-virtual {p0, v2, v0, v1, p1}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
    ...
    invoke-interface {p1, p3}, Lcom/maya/open/http/okio/BufferedSink;->writeInt(I)Lcom/maya/open/http/okio/BufferedSink;
...
.method public declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 113
    invoke-virtual {p0, p1, p3, v3, v6}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V

    .line 114
    iget-object p3, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->sink:Lcom/maya/open/http/okio/BufferedSink;

    const v2, 0x7fffffff

    and-int/2addr p2, v2

    invoke-interface {p3, p2}, Lcom/maya/open/http/okio/BufferedSink;->writeInt(I)Lcom/maya/open/http/okio/BufferedSink;
    ...
    invoke-interface {p2, p3, v4, v5}, Lcom/maya/open/http/okio/BufferedSink;->write(Lcom/maya/open/http/okio/Buffer;J)V
    ...
    .line 117
    invoke-direct {p0, p1, v0, v1}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->writeContinuationFrames(IJ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized settings(Lcom/maya/open/http/okhttp3/internal/http2/Settings;)V
    ...
    .line 192
    invoke-virtual {p0, v1, v0, v2, v1}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
    ...
    .line 194
    invoke-virtual {p1, v1}, Lcom/maya/open/http/okhttp3/internal/http2/Settings;->isSet(I)Z
    ...
    invoke-interface {v3, v0}, Lcom/maya/open/http/okio/BufferedSink;->writeShort(I)Lcom/maya/open/http/okio/BufferedSink;

    .line 202
    iget-object v0, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->sink:Lcom/maya/open/http/okio/BufferedSink;

    invoke-virtual {p1, v1}, Lcom/maya/open/http/okhttp3/internal/http2/Settings;->get(I)I

    move-result v3

    invoke-interface {v0, v3}, Lcom/maya/open/http/okio/BufferedSink;->writeInt(I)Lcom/maya/open/http/okio/BufferedSink;
...
.method public declared-synchronized synStream(ZIILjava/util/List;)V
    ...
    .line 127
    :try_start_0
    iget-boolean p3, p0, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->closed:Z
...
.method public declared-synchronized windowUpdate(IJ)V
    ...
    .line 261
    invoke-virtual {p0, p1, v1, v2, v0}, Lcom/maya/open/http/okhttp3/internal/http2/Http2Writer;->frameHeader(IIBB)V
    ...
    .line 255
    invoke-static {p1, v1}, Lcom/maya/open/http/okhttp3/internal/http2/Http2;->illegalArgument(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/IllegalArgumentException;
