...
.method private pruneAndGetAllocationCount(Lcom/maya/open/http/okhttp3/internal/connection/RealConnection;J)I
    ...
    .line 267
    :cond_1
    check-cast v3, Lcom/maya/open/http/okhttp3/internal/connection/StreamAllocation$StreamAllocationReference;
    ...
    invoke-virtual {v5}, Lcom/maya/open/http/okhttp3/Route;->address()Lcom/maya/open/http/okhttp3/Address;

    move-result-object v5

    invoke-virtual {v5}, Lcom/maya/open/http/okhttp3/Address;->url()Lcom/maya/open/http/okhttp3/HttpUrl;
    ...
    iget-object v3, v3, Lcom/maya/open/http/okhttp3/internal/connection/StreamAllocation$StreamAllocationReference;->callStackTrace:Ljava/lang/Object;

    invoke-virtual {v5, v4, v3}, Lcom/maya/open/http/okhttp3/internal/platform/Platform;->logCloseableLeak(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 274
    iput-boolean v3, p1, Lcom/maya/open/http/okhttp3/internal/connection/RealConnection;->noNewStreams:Z
    ...
    .line 278
    iget-wide v2, p0, Lcom/maya/open/http/okhttp3/ConnectionPool;->keepAliveDurationNs:J
...
.method cleanup(J)J
    ...
    check-cast v7, Lcom/maya/open/http/okhttp3/internal/connection/RealConnection;

    .line 211
    invoke-direct {p0, v7, p1, p2}, Lcom/maya/open/http/okhttp3/ConnectionPool;->pruneAndGetAllocationCount(Lcom/maya/open/http/okhttp3/internal/connection/RealConnection;J)I
    ...
    .line 219
    iget-wide v8, v7, Lcom/maya/open/http/okhttp3/internal/connection/RealConnection;->idleAtNanos:J
    ...
    .line 226
    :cond_2
    iget-wide p1, p0, Lcom/maya/open/http/okhttp3/ConnectionPool;->keepAliveDurationNs:J

    cmp-long v0, v3, p1

    if-gez v0, :cond_6

    iget p1, p0, Lcom/maya/open/http/okhttp3/ConnectionPool;->maxIdleConnections:I
    ...
    .line 239
    :cond_5
    iput-boolean v1, p0, Lcom/maya/open/http/okhttp3/ConnectionPool;->cleanupRunning:Z
    ...
    :cond_6
    :goto_1
    iget-object p1, p0, Lcom/maya/open/http/okhttp3/ConnectionPool;->connections:Ljava/util/Deque;
    ...
    .line 244
    invoke-virtual {v5}, Lcom/maya/open/http/okhttp3/internal/connection/RealConnection;->socket()Ljava/net/Socket;
...
.method public declared-synchronized idleConnectionCount()I
    ...
    .line 106
    iget-object v2, v2, Lcom/maya/open/http/okhttp3/internal/connection/RealConnection;->allocations:Ljava/util/List;
