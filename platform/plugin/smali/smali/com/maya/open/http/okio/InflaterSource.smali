...
.method public constructor <init>(Lcom/maya/open/http/okio/Source;Ljava/util/zip/Inflater;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/maya/open/http/okio/InflaterSource;-><init>(Lcom/maya/open/http/okio/BufferedSource;Ljava/util/zip/Inflater;)V
...
.method public read(Lcom/maya/open/http/okio/Buffer;J)J
    ...
    .line 74
    :try_start_0
    invoke-virtual {p1, p3}, Lcom/maya/open/http/okio/Buffer;->writableSegment(I)Lcom/maya/open/http/okio/Segment;
    ...
    iget-object v1, p3, Lcom/maya/open/http/okio/Segment;->data:[B

    iget v2, p3, Lcom/maya/open/http/okio/Segment;->limit:I

    iget v3, p3, Lcom/maya/open/http/okio/Segment;->limit:I
    ...
    .line 77
    iget p2, p3, Lcom/maya/open/http/okio/Segment;->limit:I

    add-int/2addr p2, v0

    iput p2, p3, Lcom/maya/open/http/okio/Segment;->limit:I

    .line 78
    iget-wide p2, p1, Lcom/maya/open/http/okio/Buffer;->size:J

    int-to-long v0, v0

    add-long/2addr p2, v0

    iput-wide p2, p1, Lcom/maya/open/http/okio/Buffer;->size:J
    ...
    .line 83
    iget p2, p3, Lcom/maya/open/http/okio/Segment;->pos:I

    iget v0, p3, Lcom/maya/open/http/okio/Segment;->limit:I

    if-ne p2, v0, :cond_5

    .line 85
    invoke-virtual {p3}, Lcom/maya/open/http/okio/Segment;->pop()Lcom/maya/open/http/okio/Segment;

    move-result-object p2

    iput-object p2, p1, Lcom/maya/open/http/okio/Buffer;->head:Lcom/maya/open/http/okio/Segment;

    .line 86
    invoke-static {p3}, Lcom/maya/open/http/okio/SegmentPool;->recycle(Lcom/maya/open/http/okio/Segment;)V
    :try_end_0
...
.method public refill()Z
    ...
    iget v4, p0, Lcom/maya/open/http/okio/InflaterSource;->bufferBytesHeldByInflater:I
